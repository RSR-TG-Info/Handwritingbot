...
@RSR.on_callback_query(filters.regex("close"))
async def closed(_, query: CallbackQuery):
    await query.message.delete()
    await query.answer()


@RSR.on_callback_query(filters.regex(pattern=r"down"))
async def down(_, CallbackQuery):
    await CallbackQuery.answer()


@RSR.on_callback_query(filters.regex(pattern=r"gets"))
...
@RSR.on_callback_query(filters.regex(pattern=r"ytdata"))
...
@RSR.on_callback_query(filters.regex(pattern=r"boom"))
